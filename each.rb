...
weather_options.each do |weather|
  if weather == "sunny"
    puts "It's bright out there! Bring some sunscreen"
  elsif weather == "snowy"
    puts "Better get your boots on! It's snowy."
  elsif weather == "freezing"
    puts "Layer up! It is freezing out there."
  elsif weather == "partly cloudy"
    puts "Going to be a gloomy one! Chin up."
  elsif weather == "drizzly"
    puts "Grab an umbrella! It's drizzling out there"
  end
end
# Challenge 2
